---
description: >-
  넷 스케이프에서 시작, 웹이 더 동적으로 변화했으면 했습니다. HTML 코드를 웹페이지 마크업으로 직접 작성하면서 웹 디자이너들,
  프로그래머들이 쉽게 요소를 조합할 수 있는 글루 언어가 필요하다고 생각했습니다. 넷 스케이프 커뮤니케이션은 자신들이 만들고 싶은
  스크립트언어가 자바와 비슷한 문법을 채용하는 것이 좋겠다고 생각했고 1995, 5월 탄생하였습니다.
---
